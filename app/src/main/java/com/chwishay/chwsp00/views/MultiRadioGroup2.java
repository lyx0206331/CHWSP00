...
public class MultiRadioGroup2 extends LinearLayout {
    ...
    public MultiRadioGroup2(Context context) {
        super(context);
        setOrientation(VERTICAL);
        init();
    }

    public MultiRadioGroup2(Context context, AttributeSet attrs) {
        super(context, attrs);
    ...
    @Override
    public MultiRadioGroup2.LayoutParams generateLayoutParams(AttributeSet attrs) {
        return new MultiRadioGroup2.LayoutParams(getContext(), attrs);
    }

    @Override
    protected boolean checkLayoutParams(ViewGroup.LayoutParams p) {
        return p instanceof MultiRadioGroup2.LayoutParams;
    }

    @Override
    protected LinearLayout.LayoutParams generateDefaultLayoutParams() {
        return new MultiRadioGroup2.LayoutParams(MultiRadioGroup2.LayoutParams.WRAP_CONTENT, MultiRadioGroup2.LayoutParams.WRAP_CONTENT);
    }

    @Override
    public CharSequence getAccessibilityClassName() {
        return MultiRadioGroup2.class.getName();
    }
    ...
    public interface OnCheckedChangeListener {
        public void onCheckedChanged(MultiRadioGroup2 group, @IdRes int checkedId);
    }
    ...
    private class PassThroughHierarchyChangeListener implements
        ...
        public void onChildViewAdded(View parent, View child) {
            if (parent == MultiRadioGroup2.this && child instanceof ViewGroup) {
                int childCount = ((ViewGroup) child).getChildCount();
                for (int i = 0; i < childCount; i++) {
